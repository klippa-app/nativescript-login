...
declare class FBSDKAppEvents extends NSObject implements FBSDKAppEventsConfiguring, FBSDKApplicationActivating, FBSDKApplicationLifecycleObserving, FBSDKApplicationStateSetting, FBSDKEventLogging, FBSDKSourceApplicationTracking, FBSDKUserIDProviding {
	...
	(gateKeeperManager: typeof NSObject, appEventsConfigurationProvider: FBSDKAppEventsConfigurationProviding, serverConfigurationProvider: FBSDKServerConfigurationProviding, graphRequestFactory: FBSDKGraphRequestFactoryProtocol, featureChecker: FBSDKFeatureChecking, primaryDataStore: FBSDKDataPersisting, logger: typeof NSObject, settings: FBSDKSettingsProtocol, paymentObserver: FBSDKPaymentObserving, timeSpentRecorder: any, appEventsStateStore: FBSDKAppEventsStatePersisting, eventDeactivationParameterProcessor: FBSDKAppEventsParameterProcessing, restrictiveDataFilterParameterProcessor: FBSDKAppEventsParameterProcessing, atePublisherFactory: FBSDKATEPublisherCreating, appEventsStateProvider: FBSDKAppEventsStateProviding, advertiserIDProvider: FBSDKAdvertiserIDProviding, userDataStore: FBSDKUserDataPersisting, appEventsUtility: any, internalUtility: FBSDKInternalUtilityProtocol, capiReporter: FBSDKCAPIReporter, protectedModeManager: FBSDKAppEventsParameterProcessing, bannedParamsManager: FBSDKMACARuleMatching, stdParamEnforcementManager: FBSDKMACARuleMatching, macaRuleMatchingManager: FBSDKMACARuleMatching, blocklistEventsManager: FBSDKEventsProcessing, redactedEventsManager: FBSDKEventsProcessing, sensitiveParamsManager: FBSDKAppEventsParameterProcessing, transactionObserver: FBSDKTransactionObserving, failedTransactionLoggingFactory: FBSDKIAPFailedTransactionLoggingCreating, iapDedupeProcessor: FBSDKIAPDedupeProcessing, iapTransactionCache: FBSDKIAPTransactionCaching): void;
...
declare class FBSDKAppLinkUtility extends NSObject {
	...
	static configureWithGraphRequestFactoryInfoDictionaryProviderSettingsAppEventsConfigurationProviderAdvertiserIDProviderAppEventsDropDeterminerAppEventParametersExtractorAppLinkURLFactoryUserIDProviderUserDataStore(graphRequestFactory: FBSDKGraphRequestFactoryProtocol, infoDictionaryProvider: FBSDKInfoDictionaryProviding, settings: FBSDKSettingsProtocol, appEventsConfigurationProvider: FBSDKAppEventsConfigurationProviding, advertiserIDProvider: FBSDKAdvertiserIDProviding, appEventsDropDeterminer: FBSDKAppEventDropDetermining, appEventParametersExtractor: FBSDKAppEventParametersExtracting, appLinkURLFactory: FBSDKAppLinkURLCreating, userIDProvider: FBSDKUserIDProviding, userDataStore: FBSDKUserDataPersisting): void;
...
declare class FBSDKGraphRequestConnection extends NSObject implements FBSDKGraphRequestConnecting {
	...
	static configureWithURLSessionProxyFactoryErrorConfigurationProviderPiggybackManagerSettingsGraphRequestConnectionFactoryEventLoggerOperatingSystemVersionComparerMacCatalystDeterminatorAccessTokenProviderErrorFactoryAuthenticationTokenProvider(proxyFactory: FBSDKURLSessionProxyProviding, errorConfigurationProvider: FBSDKErrorConfigurationProviding, piggybackManager: FBSDKGraphRequestPiggybackManaging, settings: FBSDKSettingsProtocol, factory: FBSDKGraphRequestConnectionFactoryProtocol, eventLogger: FBSDKEventLogging, operatingSystemVersionComparer: FBSDKOperatingSystemVersionComparing, macCatalystDeterminator: FBSDKMacCatalystDetermining, accessTokenProvider: typeof NSObject, errorFactory: FBSDKErrorCreating, authenticationTokenProvider: typeof NSObject): void;
...
declare class FBSDKServerConfiguration extends NSObject implements NSCopying, NSObjectProtocol, NSSecureCoding {
	...
	constructor(o: { appID: string; appName: string; loginTooltipEnabled: boolean; loginTooltipText: string; defaultShareMode: string; advertisingIDEnabled: boolean; implicitLoggingEnabled: boolean; implicitPurchaseLoggingEnabled: boolean; codelessEventsEnabled: boolean; uninstallTrackingEnabled: boolean; dialogConfigurations: NSDictionary<string, any>; dialogFlows: NSDictionary<string, any>; timestamp: Date; errorConfiguration: FBSDKErrorConfiguration; sessionTimeoutInterval: number; defaults: boolean; loggingToken: string; smartLoginOptions: FBSDKServerConfigurationSmartLoginOptions; smartLoginBookmarkIconURL: NSURL; smartLoginMenuIconURL: NSURL; updateMessage: string; eventBindings: NSArray<NSDictionary<string, any>> | NSDictionary<string, any>[]; restrictiveParams: NSDictionary<string, any>; AAMRules: NSDictionary<string, any>; suggestedEventsSetting: NSDictionary<string, any>; protectedModeRules: NSDictionary<string, any>; migratedAutoLogValues: NSDictionary<string, any>; });
